...
* 追加された機能（KOSHIAN 引用をポップアップで表示 改）  
  ...
  - \(削除\) ~~[futaba lightbox](https://github.com/akoya-tomo/futaba_lightbox/)でポップアップの画像を適用外にするオプション~~  
    引用ポップアップしたレスに含まれる画像がfutaba lightboxで表示されなくなります。  
    KOSHIAN引用メニュー（改）の誤動作対策でv.1.4.0から常に機能が有効になったのでオプションの項目は削除されました。

## インストール
[GitHub](https://github.com/akoya-tomo/koshian_popup_quote_kai/releases/download/v1.4.0/koshian_popup_quote_kai-1.4.0-an.fx.xpi)  
...
* v1.4.0 2018-04-20  
  ...
  - 「futaba lightboxでポップアップの画像を適用外にする」オプションの項目を削除  
* v1.3.0 2018-04-09  
