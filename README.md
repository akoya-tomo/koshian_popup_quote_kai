...
* 追加された機能（KOSHIAN 引用をポップアップで表示 改）  
  ...
  - ![\(New\)](images/new.png "New") 「ポップアップの文字サイズ」オプションを追加（デフォルト：0 = 標準の文字サイズ）  
    ポップアップの文字サイズを変更することができます。  

## インストール
**GitHub**  
[![インストールボタン](images/install_button.png "クリックでアドオンをインストール")](https://github.com/akoya-tomo/koshian_popup_quote_kai/releases/download/v1.7.0/koshian_popup_quote_kai-1.7.0-fx.xpi)  
...
* ![\(New\)](images/new.png "New") 返信ポップアップ上からは更なるポップアップはしません。  
